...
import 'package:pharmas/lang/messages_all.dart';
...
class AppLocalizations {
  ...
  String get lbOffer {
    return Intl.message('Offers', name: 'lbOffer');
  }
  String get lbAds {
  ...
  String get lbAddO {
    return Intl.message('Are you sure add this offer to cart', name: 'lbAddO');
  ...
  String get lbMyOre {
    return Intl.message('My Order', name: 'lbMyOre');
