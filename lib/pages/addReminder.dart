...
import 'package:pharmas/actions/actions.dart';
import 'package:pharmas/store/AppState.dart';
import 'package:pharmas/store/store.dart';
...
class addRem extends StatefulWidget {
  ...
  @override
  _addRem createState() => new _addRem();
}

class _addRem extends State<addRem> {
  final MethodChannel platform =
  MethodChannel('crossingthestreams.io/resourceResolver');
  bool playMusicReminder = true;
  bool lookAfterPlantsReminder = true;
  bool walkFor5minReminder = true;
  bool drinkSomeWaterReminder = true;
  bool customReminder = true;
...
// Streams are created so that app can respond to notification-related events since the plugin is initialised in the `main` function
  ...
  Future<void> _showMessagingNotification() async {
    ...
    var coworker = Person(
      ...
      key: '2',
      uri: 'tel:9876543210',
      icon: FlutterBitmapAssetAndroidIcon('assets/images/location.png'),
    );
  ...
  Future<void> _repeatNotification() async {
    ...
    await flutterLocalNotificationsPlugin.periodicallyShow(0, 'repeating title',
        'repeating body', RepeatInterval.Daily, platformChannelSpecifics,  payload: 'Test Payload',);
  }
  ...
  void _configureCustomReminder(bool value) {
    ...
    scheduleNotification(
        flutterLocalNotificationsPlugin, '4', 'test3', notificationTime);
  }
            ...
            child: Column(
              children: <Widget>[
                ...
                PaddedRaisedButton(
                  ...
                  onPressed: () async {
                    await _configureCustomReminder(true);
                  },
                ),
                PaddedRaisedButton(
                  buttonText:
