  ...
  void filterSearchResults(String query) {
    ...
    if (query.isNotEmpty || query != "") {
      ...
      dummySearchList.forEach((item) {
        ...
        g=query.length;
          if (item.Durg.toLowerCase().trimLeft().substring(0,g).contains(query.toLowerCase())) {
    ...
    if (query.isNotEmpty || query != "") {
     ...
     /*  if(waredrug==null){
       ...
       waredrug=waredrug;
        ...
        y=query.length;
        print(dummySearchList[dummySearchList.indexOf(item)].drugList.listStoreDrug);

        String indexItem = item.drugList.listStoreDrug[waredrug.indexOf(waredrug)].name;
          if (item.Name.toLowerCase().trimLeft().substring(0, y).contains(
              query.toLowerCase()) ||
              indexItem.toLowerCase().trimLeft().substring(0, y).contains(
                  query.toLowerCase())) {
            dummyListData.add(item);
            // y++;
            print(y.toString());
      ...
      if (citynum == null) {
        if (activeSearchWare == true) {
          if (chch == null) {
            ...
            responseWare = await _repository.getWareList(sessionId, data,langSave);
//offerList = response.results.offers.listOffer;
            //   response = blocOffer.getOfferList(sessionId, data);
...
print(orderLi);
      ...
      itemsWare.forEach((item) {
        ...
        for(int j=0;j<itemsWare[indexItem].drugList.listStoreDrug.length;j++){
    ...
    if (activeSearch) {
      ...
      return AppBar(
        leading:  orderLi != null
            ?orderLi.length != 0? orderLi[0].session==widget.sess?GestureDetector(
          child: Visibility(
            child: Padding(
  ...
  @override
  Widget build(BuildContext context) {  setState(() => this.context = context);
    ...
    return new WillPopScope(child: Scaffold(
      ...
      appBar: text == 'Pharma'
        ...
        centerTitle: true,
        leading:  orderLi !=null
            ? orderLi.length != 0?orderLi[0].session==widget.sess?
        GestureDetector(
          child: Visibility(
            child: Padding(
              padding: EdgeInsets.fromLTRB(5, 0, 5, 0),
      ...
      body: text == 'Home'
          ...
          return ErrorHandle(snapshot.data.error);
                ...
                manfList = snapshot.data.resultsManf.manfHome.listmanfHome;
                adsList =
                                                  ...
                                                  return Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <
                                                          ...
                                                          i.type.toString()=='2'?Visibility(visible: true,
                                              ...
                                              Row(
                                                ...
                                                children: <
                                                  ...
                                                  Row(
                                                    children: <Widget>[
                                                      Padding(
                                                        child: Text(itemsOffer[index].mane,style: TextStyle(color:Colors.red)),
                                                        padding: EdgeInsets.fromLTRB(5, 0, 5, 0),
                                                      )
                                                    ],
                                                  ),
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  Padding(
                                                    ...
                                                    children: <Widget>[
                                                      Padding(
                                                        child: Text(tListallOffer[index].mane,style: TextStyle(color:Colors.red)),
                                                        padding: EdgeInsets.fromLTRB(5, 0, 5, 0),
                                                      )
                                                    ],
                                                  ),
                                            ...
                                            Padding(
                                              ...
                                              Row(
                                                children: <Widget>[
                                                 ...
                                                 Text(                                                          AppLocalizations().lbGift+' : ' + tListallOffer[index].Gift,
                                                 ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            ...
            title:text == 'Home'? Text(AppLocalizations().lbHome,style: TextStyle(color: Colors.praimarydark),):
            Text(AppLocalizations().lbHome,style: TextStyle(color: Colors.greyapp),)
          ),
          BottomNavigationBarItem(
            icon: text == 'Store'
  ...
  title:text == 'Store'? Text(AppLocalizations().lbWare,style: TextStyle(color: Colors.praimarydark),):
  Text(AppLocalizations().lbWare,style: TextStyle(color: Colors.greyapp),)
  ...
  title:text == 'Pharma'? Text(AppLocalizations().lbOffer,style: TextStyle(color: Colors.praimarydark),):
  Text(AppLocalizations().lbOffer,style: TextStyle(color: Colors.greyapp),)
          ),
          BottomNavigationBarItem(
            icon: text == 'Settings'
                ? Image.asset('assets/images/mores.png')
                : Image.asset('assets/images/morehome.png'),
  title:text == 'Settings'? Text(AppLocalizations().lbOther,style: TextStyle(color: Colors.praimarydark),):
  Text(AppLocalizations().lbOther,style: TextStyle(color: Colors.greyapp),)
          ),
        ],
        onTap: _onTap,
      ),
